...
<div class="contact-section">
		...
		<div class="row">
			...
			<!-- css -->
				...
				<h1 class="section-header">Products in <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Gadget Badget System</span></h1>
			...
			<div class="leftside">
				...
				<div class="col-md-6 form-line">
					...
					<input id="pDate" name="pDate" type="text" class="form-control form-control-sm"> <br> 
					</div>
					...
					<input id="pDes" name="pDes" type="text" class="form-control form-control-sm"> <br>
					</div>
					
						<div id="savedBu">
						<input id="btnSave" name="btnSave" type="button" value="Save" class="btn btn-outline-warning">
						</div>
				...
				<div id="divItemsGrid">
					<%
					GadgetProduct itemObj = new GadgetProduct();
